...
public class LineFreq {
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (otherArgs.length != 2) {
            System.err.println("Usage: LineFreq <in> <out>");
            System.exit(2);
        }
        Job job = Job.getInstance(conf);
        job.setJobName("Top N");
        job.setJarByClass(LineFreq.class);
        job.setMapperClass(LineFreqMapper.class);
        //job.setCombinerClass(LineFreqReducer.class);
        job.setReducerClass(LineFreqReducer.class);
     ...
     */
    public static class LineFreqMapper extends Mapper<Object, Text, Text, IntWritable> {
        ...
        public void map(Object key, Text value, Context context) throws IOException, InterruptedException {
            ...
            while (itr.hasMoreTokens()) {
                ...
                if (!data.contains(word.toString())){
     ...
     */
    public static class LineFreqReducer extends Reducer<Text, IntWritable, Text, IntWritable> {
        ...
        protected void cleanup(Context context) throws IOException, InterruptedException {
            ...
            //MiscUtils newEmp = new MiscUtils();
     ...
     * map, increments its value, otherwise sets it to 1.
     */
    public static class LineFreqCombiner extends Reducer<Text, IntWritable, Text, IntWritable> {
